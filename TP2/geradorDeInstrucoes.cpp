...
#define TAM_FOR 70 //Tamanho dos blocos de instrucoes.
#define REPETICOES 10 /* (0 <= REPETICOES <= 100) Porcentagem que representa a quantidade de blocos de FOR repetidos dentro do NUM_INS.
